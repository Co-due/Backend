...
public interface AccountOpenApi {
    ...
    ResponseEntity<SuccessResponse> login(@Valid @RequestBody AccountLoginRequest accountLoginRequest,
    ...
    ResponseEntity<SuccessResponse> loginInfo(@CookieValue("token") String token);
    ...
    ResponseEntity<SuccessResponse> createAccount(@Valid @RequestBody SignupRequest signupRequest)
    ...
    ResponseEntity<SuccessResponse> logout(HttpServletRequest request, HttpServletResponse response);
